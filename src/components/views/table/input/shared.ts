...
export const tableInputClass = tw`w-full flex-1 border-2 border-transparent bg-layer-1 px-3.5 py-2.5 text-sm font-medium outline-none focus:border-accent dark:bg-layer-1-dark`
