...
type GetAllPlaceOptions = z.infer<typeof GetAllPlaceOptions>

export const GetAllPlace = async ({filter: {id, top, countrySlug, citySlug, placeType, placeTag}, query, sort, limit}: GetAllPlaceOptions): Promise<Place[]> => {
